...
class AutomatorWP_Invite_Anyone_Send_Invite extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User sends an invitation', 'automatorwp-invite-anyone-integration' ),
            'select_option'     => __( 'User <strong>sends</strong> an invitation', 'automatorwp-invite-anyone-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User sends an invitation %1$s time(s)', 'automatorwp-invite-anyone-integration' ), '{times}' ),
            'log_label'         => __( 'User sends an invitation', 'automatorwp-invite-anyone-integration' ),
